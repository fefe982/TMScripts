...
* */
declare function GM_addElement(tag_name: string, attributes: object): void;

/*
创建一个由“tag_name”指定的 HTML 元素并应用所有给定的“属性”并返回注入的 HTML 元素。如果给出了“parent_node”，则将其附加到它或以其他方式附加到文档头或体。
* */
declare function GM_addElement(parent_node: HTMLElement, tag_name: string, attributes: object): void;
...
使用此 url 打开一个新选项卡。
* */
declare function GM_openInTab(url: string, options: GM_Types.OpenTabOptions): openInTabResponse;
/*
使用此 url 打开一个新选项卡。
* */
...
使用此 url 打开一个新选项卡。
* */
declare function GM_openInTab(url: string): openInTabResponse;
...
declare namespace GM {
  interface XmlHttpRequestResponse<T = any> {
    finalUrl: string;
    readyState: number;
    status: number;
    statusText: string;
  ...
  interface XmlHttpRequestDetails {
    ...
    onabort?: (response: XmlHttpRequestResponse) => void;
    onerror?: (response: XmlHttpRequestResponse) => void;
    onloadstart?: (response: XmlHttpRequestResponse) => void;
    onprogress?: (response: XmlHttpRequestResponse) => void;
    onreadystatechange?: (response: XmlHttpRequestResponse) => void;
    ontimeout?: (response: XmlHttpRequestResponse) => void;
    onload?: (response: XmlHttpRequestResponse) => void;
  }

  interface XmlHttpRequestPromise<T = any> extends Promise<XmlHttpRequestResponse<T>> {
    abort: () => void;
  }

  function xmlHttpRequest<T = any>(details: XmlHttpRequestDetails): XmlHttpRequestPromise<T>;
}

// Legacy function declaration (non-promise version)
declare function GM_xmlhttpRequest(details: GM.XmlHttpRequestDetails): { abort: () => void };
